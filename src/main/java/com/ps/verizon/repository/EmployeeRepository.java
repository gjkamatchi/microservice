...
//	@Query(value = " SELECT com.ps.verizon.response.SalaryRange(salary , CASE " 
//			+ " WHEN salary BETWEEN 0 and 5000 THEN 'range1'"
//			+ " WHEN salary BETWEEN 5001 and 10000 THEN 'range2'" 
//			+ " WHEN salary BETWEEN 10001 and 20000 THEN 'range3'"
//			+ " WHEN salary BETWEEN 20001 and 30000 THEN 'range4'"
//			+ " WHEN salary BETWEEN 30001 and 40000 THEN 'range5'"
//			+ " WHEN salary BETWEEN 40001 and 50000 THEN 'range6'"
//			+ " WHEN salary BETWEEN 50001 and 60000 THEN 'range7'"
//			+ " WHEN salary BETWEEN 60001 and 70000 THEN 'range8'"
//			+ " WHEN salary BETWEEN 70001 and 80000 THEN 'range9'"
//			+ " WHEN salary BETWEEN 80001 and 90000 THEN 'range10'"
//			+ " WHEN salary BETWEEN 90001 and 100000 THEN 'range11'" 
//			+ " WHEN salary  > 100000  THEN 'range12'"
//			+ " END  as range)  FROM Employee "
//			+ " WHERE COMPETENCIES IN (:competency) GROUP BY range,salary ")
//	List<SalaryRange> findSalaryRangeByCompetency(@Param(value = "competency") final String competency);
}
